        ...
        <CustomLayout>
            <div className="px-[24px] py-[40px]">
                <div className="flex items-center gap-2 mb-[40px]">
                    ...
                    <span className="text-[16px] font-medium text-(--text-gray-scale-900)">Sign Up</span>
                </div>
                <div className="min-h-screen flex flex-col items-center">
                    <div className="w-full max-w-sm shadow-md border border-gray-200 rounded-lg p-6 bg-white">
                        <h2 className="text-[18px] font-medium mb-4 text-center text-(--text-gray-scale-900)">Create Account</h2>
                        <SignUpForm />
                    </div>
                </div>
            </div>
